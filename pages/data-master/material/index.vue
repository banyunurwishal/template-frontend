        ...
        <b-row>
          ...
          <b-col cols="2" class="text-right">
            <a
              ...
              @click="handleAdd()"
            >
              <i class="fas fa-plus" style="font-size: 12px"> </i> Add Material
            </a>
          </b-col>
        </b-row>
          ...
          <b-col>
            ...
            >
              ...
              <template #cell(outlet)="data">
                <span
                  v-for="(item, index) in data.item.material_has_outlets"
                  :key="index"
                >
                  {{
                    index > 0
...
export default {
  ...
  methods: {
    ...
    handleEdit(data) {
      this.$router.push('/master-data/material/' + data.id)
    },
