...
export default {
  ...
  methods: {
    handleAdd() {
      this.$router.push('/promo-management/disc-dynamic-promo/add')
    },
    handleEdit(data) {
      this.$router.push('/promo-management/disc-dynamic-promo/' + data.id)
    },
